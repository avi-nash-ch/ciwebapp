            ...
            <div class="card card-primary">
                ...
                <form enctype="multipart/form-data" name="categoryForm" id="categoryForm" method="post" action= "<?php echo base_url(). 'admin/article/edit/'. $article['id']; ?>">
                    <div class="card-body">
                                ...
                                <select name="category_id" class="form-control <?php echo (form_error('category_id') != "") ? 'is-invalid' : ''; ?>" id="category_id">
                                    ...
                                    if (!empty($categories)) {
                                        foreach ($categories as $category) {
                                            ...
                                            //$selected = set_select('category_id', $category['id'], false); // Check if this option should be selected
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" name="title" id="title" value="<?php echo set_value('title',$article['title']) ;?>" class="form-control <?php echo (form_error('title') != "") ? 'is-invalid' : ''; ?>" placeholder="Title">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <?php if ($article['image'] != "" && file_exists('./public/uploads/articles/'.$article['image'])) { ?>
                                    <img width="300" class="mt-3" src="<?php echo base_url(). 'public/uploads/articles/'.$article['image']; ?>">
                                <?php } else { ?>
                                    <img width="300" class="mt-3" src="<?php echo base_url(). 'public/uploads/articles/no-image.jpg';?>">
                                <?php } ?>
                            ...
                            <div class="form-group">
                                <label>Author</label>
                                <input type="text" name="author" id="author" value="<?php echo set_value('author',$article['author']) ;?>" class="form-control <?php echo (form_error('author') != "") ? 'is-invalid' : ''; ?>" placeholder="Author">
                                <?php
